...
API_URL = "http://127.0.0.1:8000/api/scan-slip/"  # ถ้าเทสบนเซิร์ฟเวอร์จริง ให้เปลี่ยนเป็น IP เซิร์ฟเวอร์
IMAGE_PATH = "test.jpg"                  # ชื่อไฟล์รูปสลิปที่คุณจะใช้เทส (ต้องมีไฟล์นี้อยู่จริง)
# API_URL = "http://159.65.8.69/scan-slip/"
TOTAL_REQUESTS = 1   # จำนวนรูปรวมทั้งหมดที่จะยิงเข้าไป
CONCURRENT_USERS = 1   # จำนวนคนยิงพร้อมกัน (ยิ่งเยอะ เซิร์ฟเวอร์ยิ่งทำงานหนัก)
